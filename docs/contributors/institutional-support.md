...
Payment is made to **netizen.org** via vendor invoice. As a 501(c)3 nonprofit, netizen.org can also accept tax-deductible donations. To discuss arrangements, contact [hi@netizen.org](mailto:hi@netizen.org).
...
For site analytics, netnet.studio uses [Plausible](https://plausible.io), a privacy-preserving analytics platform that collects no personal data, sets no cookies, and is fully GDPR-compliant. No data is shared with advertising networks or third-party trackers.
...
### Software Licensing
netnet.studio is released under the [GNU General Public License v3.0 (GPLv3)](https://www.gnu.org/licenses/gpl-3.0.en.html), a widely recognized open-source license. There is no proprietary software license to review, approve, or manage. The institutional support agreement is a **professional services contract** with netizen.org, equivalent to a technical support agreement or consulting engagement, not a software procurement.

### Existing Site Licenses and Enterprise Agreements
...
- University of Chicago — Media Art and Design program
