...
<strong style="font-size:1.25rem; color: var(--netizen-comment);">Visit the [coding docs](coding.md) to learn more about this menu and how to create **sketches** and **projects**.</strong>
<br><br>
...
<strong style="font-size:1.25rem; color: var(--netizen-comment);">Visit the [learning docs](learning.md) to read more about this widget and it's various "learning modes" and educational resources.</strong>
<br><br>
