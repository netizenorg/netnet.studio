...
window.CONVOS['template-html-meta-tags'] = (self) => {
  return [
    ...
    },
    {
      ...
      options: {
        'I see': (e) => e.goTo('og-url2')
      }
    },
    {
      id: 'html-basic',
      graph: { id: 12, x: 175, y: 125 },
