...
<iframe src="https://www.360visio.com/wp-content/uploads/v2/20b-Milano360/20h-1-Chiese/5-AltreChiese/3sEustorgio/3m463e-sEustorgioTorelli/output/index.html"></iframe>`,
    ...
    before: () => {
      ...
      NNW._whenCSSTransitionFinished(() => {
        const path = './tutorials/webvr-intro/samples/reduced1.html'
    ...
    before: () => {
      NNW._whenCSSTransitionFinished(() => {
        const path = './tutorials/webvr-intro/samples/reduced2.html'
        window.utils.get(path, (res) => {
          NNE.code = res
          NNE.highlight({
    ...
    before: () => {
      NNW._whenCSSTransitionFinished(() => {
        const path = './tutorials/webvr-intro/samples/reduced3.html'
        window.utils.get(path, (res) => {
          NNE.code = res
          NNE.highlight({
    ...
    before: () => {
      NNW._whenCSSTransitionFinished(() => {
        const path = './tutorials/webvr-intro/samples/reduced4.html'
        window.utils.get(path, (res) => {
          NNE.code = res
          NNE.highlight({
    ...
    before: () => {
      NNW._whenCSSTransitionFinished(() => {
        const path = './tutorials/webvr-intro/samples/reduced5.html'
        window.utils.get(path, (res) => {
          NNE.code = res
          NNE.highlight({
    ...
    before: () => {
      NNW._whenCSSTransitionFinished(() => {
        const path = './tutorials/webvr-intro/samples/reduced6.html'
  ...
  onload: () => {
    ...
    NNE.addCustomRoot('tutorials/webvr-intro/')
    NNE.code = TUTORIAL.bgCode
    STORE.dispatch('CHANGE_LAYOUT', 'welcome')
  },
...
`,
  ...
  widgets: {
    ...
    'origins-stereoscope': new Widget({
      ...
      innerHTML: '<img style="width:100%" src="tutorials/webvr-intro/images/stereoscope.jpg">'
    }),
    'origins-gifs': new Widget({
      width: window.innerWidth * 0.25,
      listed: false,
      title: 'Stereoscope Images converted to Gifs',
      innerHTML: '<img style="width:100%" src="tutorials/webvr-intro/images/origins-gifs-1.gif"><br><button onclick="TUTORIAL.nextGif(\'origins-gifs\', 6)">next</button>'
    }),
    ...
    'origins-sensorama': new Widget({
      ...
      innerHTML: '<img style="width:100%" src="tutorials/webvr-intro/images/sensorama.jpg"><br><p>The "Sensorama" by filmmaker Morton Heilig</p>'
    }),
    ...
    '90s-char-davies': new Widget({
      ...
      innerHTML: '<img style="width:100%" src="tutorials/webvr-intro/images/char-davies.jpg"><br><p><a href="https://en.wikipedia.org/wiki/Char_Davies" target="_blank">Char Davies</a> is a Canadian contemporary aritist known for creating immersive virtual reality artworks.</p>'
    }),
    ...
    'xr-spectrum': new Widget({
      ...
      innerHTML: '<img style="width:100%" src="tutorials/webvr-intro/images/spectrum.png">'
    }),
    'vr-vive': new Widget({
      width: window.innerWidth * 0.5,
      listed: false,
  ...
  nextGif: (id, max) => {
    ...
    img.src = `tutorials/webvr-intro/images/${id}-${idx}.gif`
  },
