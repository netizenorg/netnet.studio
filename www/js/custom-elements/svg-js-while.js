...
class SvgJSWhile extends HTMLElement {
  ...
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <polyline points="439.59 199.11 439.59 185.21 503.88 185.21 567.59 185.21 567.59 199.11"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="503.89" y1="168.11" x2="503.89" y2="184.11"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <text transform="translate(266.48 384.52)"
      style="isolation:isolate;font-size:57.13840103149414px;fill:${this.c[0]};font-family:'fira-sans-regular', sans-serif">}</text>
    <text transform="translate(266.48 247.39)"
    ...
    <polyline points="262.81 61.35 262.81 47.45 372.26 47.45 480.74 47.45 480.74 61.35"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="372.26" y1="30.35" x2="372.26" y2="46.35"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <polyline points="375.19 311.21 375.19 325.11 332.18 325.11 289.36 325.11 289.36 311.21"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="332.18" y1="342.21" x2="332.18" y2="326.21"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <text transform="translate(296.36 361.1)"
    ...
    <text transform="translate(266.62 109.79)"
