...
class SvgJSDefineFunction extends HTMLElement {
  ...
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <text transform="translate(236.96 24.44)"
    ...
    <polyline points="499.65 193.39 499.65 207.29 348.05 207.29 196.46 207.29 196.46 193.39"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="348.05" y1="224.39" x2="348.05" y2="208.49"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <polyline points="398.46 63.7 398.46 49.8 487.38 49.8 575.5 49.8 575.5 63.7"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="487.38" y1="32.7" x2="487.38" y2="48.7"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <polyline points="168.5 63.7 168.5 49.8 279.25 49.8 389.58 49.8 389.58 63.7"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="279.25" y1="32.7" x2="279.25" y2="48.7"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    ...
    <text transform="translate(461.14 185.21)"
      style="isolation:isolate;font-size:57.13840103149414px;fill:${this.c[8]};font-family:'fira-sans-regular', sans-serif">x</text>
    <text transform="translate(420.86 185.21)"
      style="isolation:isolate;font-size:57.13840103149414px;fill:${this.c[3]};font-family:'fira-sans-regular', sans-serif">*</text>
    <polyline points="613.72 63.7 613.72 49.8 627.19 49.8 640.53 49.8 640.53 63.7"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="627.19" y1="32.7" x2="627.19" y2="48.7"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <text transform="translate(571.64 24.44)"
