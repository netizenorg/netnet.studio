...
class SvgJSConditional extends HTMLElement {
  ...
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <text transform="translate(86.25 31.68)"
    ...
    <text transform="translate(200.19 31.68)"
      style="isolation:isolate;font-size:23.2268009185791px;fill:${this.c[5]};font-family:'fira-sans-regular', sans-serif">question
      <tspan x="92.35" y="0" style="letter-spacing:-0.04999107783161007em">/</tspan>
      <tspan x="103.27" y="0" style="letter-spacing:-0.015009936741702938em">c</tspan>
      <tspan x="114.02" y="0">ondition</tspan>
    </text>
    <polyline points="162.45 70.94 162.45 57.04 280.46 57.04 397.41 57.04 397.41 70.94"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="280.46" y1="39.94" x2="280.46" y2="55.94"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <polyline points="106.35 70.94 106.35 57.04 130.38 57.04 154.31 57.04 154.31 70.94"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="130.38" y1="39.94" x2="130.38" y2="55.94"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    ...
    <polyline points="569.45 70.94 583.35 70.94 583.35 170.6 583.35 268.78 569.45 268.78"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <line x1="600.45" y1="170.6" x2="584.45" y2="170.6"
      style="fill:none;stroke:${this.c[5]};stroke-width:2px" />
    <text transform="translate(605.44 163.22)"
      style="isolation:isolate;font-size:23.2268009185791px;fill:${this.c[5]};font-family:'fira-sans-regular', sans-serif">
      ...
      <tspan x="112.09" y="0" style="letter-spacing:-0.000021022320366530724em">l</tspan>
      <tspan x="0" y="27.87">b</tspan>
      <tspan x="13.61" y="27.87" style="letter-spacing:-0.005003312247234312em">l</tspan>
      <tspan x="20.32" y="27.87">ock</tspan>
    </text>
