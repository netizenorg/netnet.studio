...
class SvgTagPresentation extends HTMLElement {
  ...
  updateHTML (s = 0) {
    ...
    if (s === 10) {
      ...
      this.clearTimers()
      const anim = this.querySelector('#svgTagPres')
    ...
    if (num === 0) {
      ...
      <text
        ...
        <animate
          ...
          from="0" to="1" dur="0.75s"
          calcMode="spline" keySplines="0 0 0.58 1"
          fill="freeze" begin="svgTagPres.begin+0.75s">
      </text>
      <path
        ...
        <animate
          ...
          keyTimes="0; 0.5; 1"
          calcMode="linear"
          fill="freeze" begin="svgTagPres.begin+0s">
      </path>
      <text
        x="45"
        y="4"
      ...
      <path
        ...
        <animate
          ...
          fill="freeze" begin="svgTagPres.begin+0.5s">
      </path>
      <text
        x="19"
        y="32"
      ...
      <text
        ...
        <animate
          ...
          from="0" to="1" dur="0.75s"
          calcMode="spline" keySplines="0 0 0.58 1"
          fill="freeze" begin="svgTagPres.begin+1.5s">
      </text>`
    } else if (num === 12) {
      return `<text
        x="38"
      ...
      <text
        ...
        <animate
          ...
          from="0" to="1" dur="0.75s"
          calcMode="spline" keySplines="0 0 0.58 1"
          fill="freeze" begin="svgTagPres.begin+1s"/>
      </text>
      <text
        x="18.7"
        y="20"
      ...
      <text
        ...
        <animate
          ...
          calcMode="spline" keySplines="0 0 0.58 1"
          fill="freeze" begin="svgTagPres.begin+1.25s"/>
      </text>`
    } else if (num === 18) {
      return `<text
        x="1"
...
window.customElements.define('svg-tag-presentation', SvgTagPresentation)
