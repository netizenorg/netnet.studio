...
class CssReference extends Widget {
  constructor (opts) {
    ...
    const init = (html) => {
      ...
      utils.get('./widgets/css-reference/data/selectors.html', (sels) => {
      ...
      utils.get('./widgets/css-reference/data/cascade.html', (text) => {
        this.cascadeOpts = {
  ...
  _createHTML () {
    ...
    // this.ele.querySelector('.widget__inner-html').style.padding = '10px 0 0'
...
a:hover {
  ...
  _createCascadeRef (html) {
    ...
    const updateExamples = () => {
      ...
      utils.get('./widgets/css-reference/data/example-1.html', (text) => {
